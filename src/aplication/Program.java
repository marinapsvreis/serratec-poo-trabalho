...
public class Program {
	...
	public static void main(String[] args) {
		...
		// Funcionario f3 = new Funcionario("Marlon", "012565667450", LocalDate.of(2000,
		// 06, 28), 3500.0);
		...
		// f1.addDependente("Joana", "09876543201", LocalDate.of(2017, 10,
		// 01),ParentescoEnum.FILHO);

		f2.addDependente("Bruno", "00011122235", LocalDate.of(2019, 03, 01), ParentescoEnum.FILHO);
		// f2.addDependente("Ana", "00011122236", LocalDate.of(2000, 03, 01),
